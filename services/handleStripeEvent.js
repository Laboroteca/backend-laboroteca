...
if (
  ...
  try {
    // 🔁 Refuerzo clave: asegurar totalAsistentes para generación de entradas y factura
    ...
    datosCliente.totalAsistentes = totalAsistentes; // Refuerzo final para factura y procesarEntradas
